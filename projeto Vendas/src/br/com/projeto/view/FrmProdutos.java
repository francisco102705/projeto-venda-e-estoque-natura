...
//metodo listar na tabela
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        //botao salvar
         if (txtdescricao.getText().matches("")|| txtpreco.getText().matches("")||txtqtdestoque.getText().matches("")){
        ...
        f = (Fornecedore) cbfornecedor.getSelectedItem();
        obj.setFornecedor(f);
    ...
    private void btneditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditarActionPerformed
        // botao  editar
        if (txtcodigo.getText().matches("")||txtdescricao.getText().matches("")|| txtpreco.getText().matches("")||txtqtdestoque.getText().matches("")){
            JOptionPane.showMessageDialog(rootPane,"selecione um para editar");
        }else{
        Produto obj = new Produto();
    ...
    private void btnexcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexcluirActionPerformed
        ...
        if (txtcodigo.getText().matches("")){
            JOptionPane.showMessageDialog(rootPane,"selecione um para excluir");
        }else{
        Produto obj = new Produto();
        obj.setId(Integer.parseInt(txtcodigo.getText()));
        ProdutoDAO dao = new ProdutoDAO();
    ...
    private void btnbuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscaActionPerformed
        ...
        if (obj.getDescricao()!= null) {
            ...
            Fornecedore f = new Fornecedore();
            FornecedoreDAO fdao = new FornecedoreDAO();
    ...
    private void cbfornecedorAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_cbfornecedorAncestorAdded
        ...
        List<Fornecedore> listadefornecedores = dao.listarFornecedores();
        cbfornecedor.removeAll();

        for (Fornecedore f : listadefornecedores) {
