...
public class FrmFuncionario extends javax.swing.JFrame {
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        //botao salvar
        if (txtnome.getText().matches("") || txtrg.getText().matches("")|| txtemail.getText().matches("")|| txtsenha.getText().matches("")|| txtcargo.getText().matches("")||cbnivel.getSelectedItem().toString().isEmpty()||txtfixo.getText().matches("")||txtcel.getText().matches("")||txtcep.getText().matches("")||txtend.getText().matches("")||txtnumero.getText().matches("")||txtcomplemento.getText().matches("")||txtbairro.getText().matches("")||txtcidade.getText().matches("")||cbuf.getSelectedItem().toString().isEmpty()){
    ...
    private void btneditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditarActionPerformed
        // botao  editar
        if (txtnome.getText().matches("") || txtrg.getText().matches("")|| txtemail.getText().matches("")|| txtsenha.getText().matches("")|| txtcargo.getText().matches("")||cbnivel.getSelectedItem().toString().isEmpty()||txtfixo.getText().matches("")||txtcel.getText().matches("")||txtcep.getText().matches("")||txtend.getText().matches("")||txtnumero.getText().matches("")||txtcomplemento.getText().matches("")||txtbairro.getText().matches("")||txtcidade.getText().matches("")||cbuf.getSelectedItem().toString().isEmpty()){
            JOptionPane.showMessageDialog(rootPane,"selecione um funcionario para editar");
        }else{
        Funcionario obj = new Funcionario();
    ...
    private void btnexcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexcluirActionPerformed
        // botao excluir
         if (txtcodigo.getText().matches("") ){
            JOptionPane.showMessageDialog(rootPane,"selecione um funcionario para excluir");
        }else{
        Funcionario obj = new Funcionario();
        obj.setId(Integer.parseInt(txtcodigo.getText()));
        FuncionarioDAO dao = new FuncionarioDAO();
