...
public class FrmFornecedores extends javax.swing.JFrame {
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        //botao salvar
        if (txtnome.getText().matches("") || txtcnpj.getText().matches("")|| txtemail.getText().matches("")|| txtfixo.getText().matches("")||txtcel.getText().matches("")||txtcep.getText().matches("")||txtend.getText().matches("")||txtnumero.getText().matches("")||txtcomplemento.getText().matches("")||txtbairro.getText().matches("")||txtcidade.getText().matches("")||cbuf.getSelectedItem().toString().isEmpty()){
    ...
    private void btnexcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexcluirActionPerformed
        ...
        if (txtcodigo.getText().matches("")){
            JOptionPane.showMessageDialog(rootPane,"Selecione algum fornecedor para excluir");
        }else{
        Fornecedore obj = new Fornecedore();
        obj.setId(Integer.parseInt(txtcodigo.getText()));
        FornecedoreDAO dao = new FornecedoreDAO();
